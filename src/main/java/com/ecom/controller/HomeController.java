...
//		m.addAttribute("products", products);
	...
	public String product(@PathVariable int id, Model m) {
		...
		// Định dạng giá tiền và giá chiết khấu
		productById.setFormattedPrice(productService.formatCurrency(productById.getPrice()));
		productById.setFormattedDiscountPrice(productService.formatCurrency(productById.getDiscountPrice()));
